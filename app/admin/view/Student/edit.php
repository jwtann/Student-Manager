    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li><a href="index.php?s=admin/student/index">stu list</a></li>
                <li><a href="index.php?s=admin/student/create">add stu</a></li>
                <li class="active"><a href="index.php?s=admin/student/edit">edit stu</a></li>
            </ul>
                ...
                <div class="panel-body">
                    <form action="" method="post" class="form-horizontal" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" id="inputID" class="form-control" value="<?php echo $student[0]['name']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <label class="radio-inline">
                                    ...
                                    <input type="radio" name="sex" value="男" <?php if ($student[0]['sex'] == '男'){ ?> checked="checked" <?php } ?>> 男
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="sex" value="女" <?php if ($student[0]['sex'] == '女'){ ?> checked="checked" <?php } ?>> 女
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="age" class="form-control" value="<?php echo $student[0]['age']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputID" class="col-sm-2 control-label">手机:</label>
                            <div class="col-sm-10">
                                <input type="number" name="phone" class="form-control" value="<?php echo $student[0]['phone']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="grade_id">
                                    ...
                                    <?php foreach ($grade as $k => $v) { ?>
                                        <?php if($v['id'] == $student[0]['grade_id']){ ?>
