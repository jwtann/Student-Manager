    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="active"><a href="index.php?s=admin/grade/edit">edit grade</a></li>
            </ul>
                ...
                <div class="panel-body">
                    <form action="" method="post" class="form-horizontal" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="inputID" class="form-control" value="<?php echo $grade['gname']; ?>" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputID" class="col-sm-2 control-label">新名称:</label>
                            <div class="col-sm-10">
